...
```bash
# On Web01
scp -r * user@web01-ip:/var/www/html/job-search/

# On Web02
scp -r * user@web02-ip:/var/www/html/job-search/
```

Set proper permissions:
```bash
sudo chown -R www-data:www-data /var/www/html/job-search
sudo chmod -R 755 /var/www/html/job-search
```
